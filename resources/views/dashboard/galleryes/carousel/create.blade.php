...
@section('container')
    ...
    <section class="content">
        ...
        <div class="content-header">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                <h1 class="m-0"  style="font-family:'point';font-size:3rem;">Create new Carousel</h1>
                <h5 style="font-size: 1rem;margin:0.6rem 0 0.8rem 0;color:#777777">make the Carousel you like</h5>
                </div><!-- /.col -->
            </div><!-- /.row -->
`
            </div><!-- /.container-fluid -->
      ...
      <section class="content">
      <div class="container-fluid">
          <form action="/dashboard/galeri/carousel" method="POST" enctype="multipart/form-data">
          @csrf
